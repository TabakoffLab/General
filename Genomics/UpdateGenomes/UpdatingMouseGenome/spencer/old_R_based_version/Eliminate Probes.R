...
write.table(reduced.full.ps,file="Masks/LXS.MoEx-1_0-st-v1.r2.dt1.mm9.full.MASKED.ps",sep="\t",col.names=FALSE,row.names=FALSE,quote=FALSE)
...
write.table(forPython,file="Masks/core.mps",quote=FALSE,sep="\t",na="0",row.names=FALSE,col.names=TRUE)
...
forPython <- forPython[order(forPython[,"transcript_cluster_id"]),]
write.table(forPython,file="Masks/extended.mps",quote=FALSE,sep="\t",na="0",row.names=FALSE,col.names=TRUE)
